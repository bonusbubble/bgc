...
void do_something()
{
    ...
    bgc_Array *some_data = bgcx_create_array(size_t, 1024 * 1024 * 100);
    ...
    bgc_Array *input = bgcx_create_array(float, 2);
    bgc_Array *hidden = bgcx_create_array(float, 3);
    bgc_Array *output = bgcx_create_array(float, 1);
}
